...
namespace dispositiontools\persistiveutm\widgets;

use dispositiontools\persistiveutm\Persistiveutm;
use dispositiontools\persistiveutm\assetbundles\utmcampaignswidget\UtmcampaignsWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * persistiveutm Widget
 *
 ...
 * @since     0.0.1
 */
class Utmcampaigns extends Widget
{
    ...
    {
        return Craft::t('persistiveutm', 'Utmcampaigns');
    }
    ...
    {
        return Craft::getAlias("@dispositiontools/persistiveutm/assetbundles/utmcampaignswidget/dist/img/Utmcampaigns-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'persistiveutm/_components/widgets/Utmcampaigns_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(UtmcampaignsWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'persistiveutm/_components/widgets/Utmcampaigns_body',
            [
